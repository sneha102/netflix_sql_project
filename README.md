...
- **Content Distribution:** Majority of Netflix content is movies, but TV shows are growing in number.
- **Common Ratings:** TV shows are often rated TV-MA, while movies skew towards PG-13 or TV-14.
- **Regional Insights:** USA, India, and UK contribute the most content.
- **Genre & Type:** Documentaries and dramas dominate the catalog.
- **Custom Analysis:** Keyword-based classification allows tagging content based on tone or violence levels.
